...
const PuzzleTests_1 = require("./PuzzleTests");
(0, mocha_1.describe)('Parser tests', function () {
    /**
     * testing strategy
    ...
    const expectedRegions = (0, PuzzleTests_1.makeRegions)(puzzle1Regions);
    const expectedSolutions = (0, PuzzleTests_1.makeSolutions)(puzzle1Solution);
    const puzzle1 = new Puzzle_1.Puzzle(10, 10, expectedRegions, expectedSolutions);
    (0, mocha_1.it)("should return correct puzzle for a file with comments", function () {
        const input = `
...
9,3  10,6 | 9,2 9,4 9,5 9,6 9,7 9,8 10,1 10,2 10,3 10,4 10,5 10,7 10,8 10,9
`;
        const result = (0, PuzzleParser_1.parsePuzzle)(input);
        assert_1.default.deepStrictEqual(result, puzzle1, 'Parsed puzzle has incorrect values');
    });
    (0, mocha_1.it)("should return correct puzzle for a file with no comments and white space", function () {
...
9,3  10,6 | 9,2 9,4 9,5 9,6 9,7 9,8 10,1 10,2 10,3 10,4 10,5 10,7 10,8 10,9`;
        const result = (0, PuzzleParser_1.parsePuzzle)(input);
        assert_1.default.deepStrictEqual(result, puzzle1, 'Incorrect parsed puzzle');
    });
    (0, mocha_1.it)("should throw error when grammar is invalid (space in point)", function () {
        const input = `
10x10
1, 2  1,5  | 1,1 1,3 1,4 1,6 1,7 1,8 2,1 2,2 2,3 2,4 2,5 2,6 2,8 3,5
2,9  4,10 | 1,9 1,10 2,10 3,9 3,10 4,9 5,9 5,10 6,9 6,10 7,10 8,10
...
9,3  10,6 | 9,2 9,4 9,5 9,6 9,7 9,8 10,1 10,2 10,3 10,4 10,5 10,7 10,8 10,9
        ...
        assert_1.default.throws(() => {
            (0, PuzzleParser_1.parsePuzzle)(input);
        }, Error, 'Coordinates cannot have a space in them');
    });
    (0, mocha_1.it)("should throw error when grammar is invalid (two regions in one line)", function () {
        const input = `
10x10
...
9,3  10,6 | 9,2 9,4 9,5 9,6 9,7 9,8 10,1 10,2 10,3 10,4 10,5 10,7 10,8 10,9
    ...
    (0, mocha_1.it)("should throw error when grammar is valid but puzzle is invalid (wrong number of points)", function () {
        const input = `
10x10
1,2  1,5  | 1,1 1,3 1,4 1,6 1,7 1,8 2,1 2,2 2,3 2,4 2,5 2,6 2,8 3,5     
2,9  4,10 | 1,9 1,10 2,10 3,9 3,10 4,9 5,9 5,10 6,9 6,10 7,10 8,10
...
//# sourceMappingURL=PuzzleParserTests.js.map